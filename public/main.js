    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(_app_routes__WEBPACK_IMPORTED_MODULE_9__["ROUTES"], { useHash: true })
            ],
            providers: [],
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(spotify) {
        ...
        this.loading = true;
        this.error = false;
        this.spotify.getNewRelease().subscribe(function (data) {
...
module.exports = "<div class=\"card-columns animated fadeIn\">\n\n    <div (click)=\"verArtista (item)\" *ngFor=\"let item of items\" class=\"card puntero\">\n        <img [src]=\"item.images | noimage \" class=\"card-img-top\" alt=\"artistas\">\n        <div class=\"card-body\">\n            <h5 class=\"card-title\"> {{item.name}}</h5>\n            <p class=\"card-text\">\n                <span *ngFor=\"let artista of item.artists\" class=\"badge badge-primary\">\n          {{artista.name}}\n        </span>\n\n            </p>\n        </div>\n    </div>\n</div>"
...
var SpotifyService = /** @class */ (function () {
    ...
    SpotifyService.prototype.getQuery = function (query) {
        ...
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            Authorization: "Bearer BQA55klc5Dm7GVpG0UiOnDsww68l9fj56zELVQXCKe8Immwkt1ioaCgSBVfU8o-lD4F2puj-mdrTYvtEBdA"
        });
        return this.http.get(url, { headers: headers });
    };
    SpotifyService.prototype.getNewRelease = function () {
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyAyH4pJ0bOjxnkXXzNGiCpxR7OhoFK8XKo",
        authDomain: "spotiapp-33566.firebaseapp.com",
        databaseURL: "https://spotiapp-33566.firebaseio.com",
        projectId: "spotiapp-33566",
        storageBucket: "spotiapp-33566.appspot.com",
        messagingSenderId: "791987000560",
        appId: "1:791987000560:web:080ab48d80f7607cd99e35"
    }
};
/*
...
module.exports = __webpack_require__(/*! /home/crusiris/Proyectos/Angular/SpotiApp/src/main.ts */"./src/main.ts");
